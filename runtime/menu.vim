...
if has("gui_macvim")
  ...
  an <silent> 9998.325 Window.Open\ File\ Browser <Nop>
  an <silent> 9998.326 Window.Close\ File\ Browser   <Nop>
...
if has("gui_macvim")
  ...
  macm Window.Open\ File\ Browser	key=<D-E>	action=openDrawer:
  macm Window.Close\ File\ Browser	key=<D-M-e>	action=closeDrawer:
